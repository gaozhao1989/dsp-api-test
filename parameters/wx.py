...
test_01_fund_transfer_add = [({'appid': 'wxd1de6b7bf1d874f9',
                               'fund_type': 'GENERAL_CASH',
                               'amount': 1,
                               'external_bill_no': 'sndo_test_{}{}'.format(dg.getdate(),
                                                                           dg.randint()),
                               'memo': 'test_transfer'},
                              {'result': True,
                               'code': 0,
...
test_01_fund_statements_detailed_get = [
    ({
        ...
        'date_range': {
            ...
            'end_date': '2019-04-29'},
        'transaction_type': 'TRANSACTION_RECHARGE'},
     {
        'result': True,
        'code': 0,
        'msg': ''},
...
test_01_campaigns_add = [({'appid': 'wxd1de6b7bf1d874f9',
...
test_02_campaigns_get = [
    ({
        'appid': 'wxd1de6b7bf1d874f9', 'campaign_id': 41704869, 'filtering': '', 'page': '', 'page_size': ''}, {
            'result': True, 'code': 0, 'msg': ''}, 'get_campaign'), ({
                'appid': 'wxd1de6b7bf1d874f9', 'campaign_id': '', 'filtering': '', 'page': '', 'page_size': ''}, {
                    'result': True, 'code': 0, 'msg': ''}, 'get_all_campaign'), ({
                        'appid': 'wxd1de6b7bf1d874f9', 'campaign_id': 'global variable', 'filtering': '', 'page': '', 'page_size': ''}, {
                            'result': True, 'code': 0, 'msg': ''}, 'get_campaign')]

test_03_campaigns_update = [({'appid': 'wxd1de6b7bf1d874f9',
...
test_01_adgroups_add = [({'appid': 'wxd1de6b7bf1d874f9',
                          'campaign_id': 'global variable',
...
test_02_adgroups_update = [({'appid': 'wxd1de6b7bf1d874f9',
...
test_03_adgroups_get = [({'appid': 'wxd1de6b7bf1d874f9',
                          'adgroup_id': 'global variable',
                          'filtering': '',
                          'page': '',
                          'page_size': ''},
...
test_01_adcreatives_add = [({'appid': 'wxd1de6b7bf1d874f9',
                             'campaign_id': 'global variable',
                             'adcreative_name': 'test_adcreative_name_{}'.format(dg.randint()),
                             'adcreative_template_id': 263,
                             'adcreative_elements': {'title': 'test_title_{}'.format(dg.randint()),
...
test_02_adcreatives_update = [({'appid': 'wxd1de6b7bf1d874f9',
                                'adcreative_id': 'global variable',
                                'adcreative_name': 'update_adcreative_name_{}'.format(dg.randint()),
                                'adcreative_elements': {'title': 'update_title_{}'.format(dg.randint()),
                                                        'image_list': ['9738853:93308213c445916a2acfa81425a643be']},
                                'destination_url':'https://www.example.com'},
                               {'result': True,
                                'code': 0,
...
test_03_adcreatives_get = [({'appid': 'wxd1de6b7bf1d874f9',
                             'adcreative_id': 'global variable',
                             'filtering': '',
                             'page': '',
                             'page_size': ''},
...
test_01_ads_add = [({'appid': 'wxd1de6b7bf1d874f9',
                     'adgroup_id': 'global variable',
                     'adcreative_id': 'global variable',
                    ...
                    {'result': True,
                     ...
                     'msg': ''},
                    'add_ad')]
test_02_ads_update = [({'appid': 'wxd1de6b7bf1d874f9',
...
test_02_images_get = [({'appid': 'wxd1de6b7bf1d874f9',
                        'image_id': 'global variable',
                        'filtering': '',
                        'page': '',
                        'page_size': ''},
                       {'result': True,
...
test_01_custom_audiences_add = [
    ({
        'appid': 'wxd1de6b7bf1d874f9', 'name': 'test_name_{}'.format(
            dg.randint()), 'type': 'CUSTOMER_FILE', 'description': 'test_description_{}'.format(
                dg.randint())}, {
                    'result': True, 'code': 0, 'msg': ''}, 'add_custom_audiences')]

test_02_custom_audiences_update = [({'appid': 'wxd1de6b7bf1d874f9',
                                     'audience_id': 'global variable',
                                     'name': 'update_name_{}'.format(dg.randint()),
                                     'type': 'CUSTOMER_FILE',
...
test_03_custom_audiences_get = [
    ({
        'appid': 'wxd1de6b7bf1d874f9', 'audience_id': 'global variable', 'page': '', 'page_size': ''}, {
            'result': True, 'code': 0, 'msg': ''}, 'get_custom_audiences'), ({
                'appid': 'wxd1de6b7bf1d874f9', 'page': '', 'page_size': ''}, {
                    'result': True, 'code': 0, 'msg': ''}, 'get_all_custom_audiences')]
test_01_custom_audience_files_add = [
    ({
        'appid': 'wxd1de6b7bf1d874f9',
        'file': pp.path_join(
            pp.current_path(),
            'misc/audiencefile.zip'),
        'user_id_type': 'QQ',
...
test_02_custom_audience_files_get = [({'appid': 'wxd1de6b7bf1d874f9',
                                       'custom_audience_file_id': 'global variable',
                                       'audience_id': '',
                                       'page': '',
                                       'page_size': ''},
                                      {'result': True,
